...
if ($ExisitngSite -eq $null){
    ...
    New-PnPSite -Type CommunicationSite -Title "Local Site Landing" -Url $SiteUrl -SiteDesign $SiteTemplate -ErrorVariable errVar -ErrorAction Continue
    ...
    Apply-PnPProvisioningTemplate -Path "LocalSitetemplate.xml" -ErrorAction Stop
	Disconnect-PnPOnline
