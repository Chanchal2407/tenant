...
$url = "https://alfalavalonline.sharepoint.com/"
...
# Additional params
$outputpath = "C:\ALFA\Code\TFS\Share Realization Project\Deployment\Scripts\Sprint 3- 2020\";
$excelPath = "C:\ALFA\Code\TFS\Share Realization Project\Deployment\Scripts\Sprint 3- 2020\AboutMeSwedenSubsitesPages.xlsx";
